...
public sealed class AccessibleWireColorMenu
{
    ...
    public void ToggleSelected()
    {
        ...
        string locKey = isNowEnabled
            ? $"Mods.ScreenReaderMod.WireColorMenu.{option.OnKey}"
            : $"Mods.ScreenReaderMod.WireColorMenu.{option.OffKey}";
    ...
    private void AnnounceCurrentSelection(bool includeMenuOpenPrefix = false)
    {
        ...
        string formatKey = "Mods.ScreenReaderMod.WireColorMenu.OptionFormat";
        ...
        if (includeMenuOpenPrefix)
        {
            string menuOpenPrefix = LocalizationHelper.GetTextOrFallback(
                "Mods.ScreenReaderMod.WireColorMenu.MenuOpenPrefix",
                "Wire Menu Opened");
