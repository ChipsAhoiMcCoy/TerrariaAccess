...
namespace TerrariaAccess.Common.Systems.ModMenuAccessibility;
...
public abstract class ModMenuAccessibilityBase : ModSystem
{
    ...
    private void UpdateInputState()
    {
        ...
        if (ShouldProcessKeyboardInput())
        {
            ...
            {
                inventorySelectNow = GamepadEmulation.VirtualTriggerService.IsKeybindPressedRaw(selectKeybind);
            }
