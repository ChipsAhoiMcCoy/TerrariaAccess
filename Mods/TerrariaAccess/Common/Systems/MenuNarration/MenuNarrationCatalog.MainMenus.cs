...
internal static partial class MenuNarrationCatalog
{
    ...
    private static void InvokeOptionalAddMenuButtons(string[] names, float[] scales, ref int offY, ref int spacing, ref int buttonIndex, ref int numButtons)
    {
        ...
        {
            TerrariaAccess.Instance?.Logger.Debug($"[MenuNarration] Interface.AddMenuButtons reflection failed: {ex.Message}");
        }
    }
    ...
    private static string GetSelectedPlayerName()
    {
        ...
        {
            TerrariaAccess.Instance?.Logger.Debug($"[MenuNarration] Failed to resolve selected player: {ex.Message}");
        }
    ...
    private static string GetSelectedWorldName()
    {
        ...
        {
            TerrariaAccess.Instance?.Logger.Debug($"[MenuNarration] Failed to resolve selected world: {ex.Message}");
        }
