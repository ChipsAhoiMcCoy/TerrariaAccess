...
/// <summary>
/// Announces biome changes when the player moves between different biomes.
/// </summary>
internal sealed class BiomeEmitter : AudioEmitterBase
{
    ...
    private static void AnnounceBiome(BiomeDefinition biome)
    {
        ...
        string template = LocalizationHelper.GetTextOrFallback(
            "Mods.TerrariaAccess.WorldAnnouncements.BiomeEntered",
            "Entered {0}.");
