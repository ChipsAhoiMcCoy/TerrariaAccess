...
- Spatial audio for footsteps, enemy proximity, multiplayer footsteps, cursor position, UI slots, wall collision, edge detection, fall proximity, passage detection, and overhead traversal cues.
